...
export const HIGHLIGHTED_ARTICLES_RFKID = 'gileadcom_search_home_highlight_articles';
...
// Search widget IDs
export const PREVIEW_WIDGET_ID = 'gileadcom_preview_search';
export const SEARCH_WIDGET_ID = 'gileadcom_search_results';
export const HOMEHIGHLIGHTED_WIDGET_ID = 'gileadcom_search_home_highlight_articles';
